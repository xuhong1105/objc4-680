...
// 关于 runtime.h 和 objc-runtime-new.h/.m 之间的关系是：
// objc-runtime-new.h 中定义了 objc_class 等重要的结构体，
// runtime.h 作为 public header，其中定义了假的 objc_class，用于隐藏底层实现；并且暴露出大量的全局函数给用户，用以操作 runtime，这些全局函数的实现分布在多个文件中
// 

/* Types */

#if !OBJC_TYPES_DEFINED // 下面的代码不会被编译 ------------------------------------
 ...
 */
// 取得 cls 类的中 sel 对应的方法，注意是 Method(method_t) 类型，并不只有 IMP
